...
import {
  ...
  MapPin, DollarSign, Clock, X, Upload, Save
} from 'lucide-react';
...
export default function AdminTrips() {
  ...
  const openForm = (trip?: Trip) => {
    setFormData(trip ? { ...trip } : { ...emptyTrip });
    setView('form');
  };
          ...
          <div key={trip.id} className="bg-slate-900 rounded-xl border border-slate-800 hover:border-slate-700 transition-all overflow-hidden flex flex-col sm:flex-row">
            ...
            <div className="flex-1 p-5 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-800">
                ...
                <button className="px-3 py-1.5 rounded-md bg-red-500/10 text-red-400 border border-red-500/20 text-xs font-medium hover:bg-red-500/20 transition-all flex items-center gap-1.5">
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
        ...
        <div className="p-6 lg:p-8 space-y-6">
          ...
          <div className="flex gap-3 pt-4 border-t border-slate-800">
            ...
            <button className="px-5 py-2.5 rounded-lg bg-red-500/10 text-red-400 border border-red-500/20 text-sm font-medium hover:bg-red-500/20 transition-all flex items-center gap-2">
